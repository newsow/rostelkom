    ...
    <div className="flex flex-row h-full w-full overflow-x-hidden">
      ...
      <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
        <div className="flex flex-row items-center justify-center h-12 w-full">
          <div className="ml-2 font-bold text-2xl">Чат жильцов Московская 31</div>
        </div>
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="flex flex-col space-y-1 mt-4 -mx-2 h-48 overflow-y-auto">
            ...
            >
              ...
              <div className="ml-2 text-sm font-semibold">Иванов Иван</div>
            </button>
            <button
              className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
            >
              ...
              <div className="ml-2 text-sm font-semibold">Мария Кюри</div>
            </button>
            <button
              className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
            >
              ...
              <div className="ml-2 text-sm font-semibold">Филлип Жданов</div>
            </button>
            <button
              className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
            >
              ...
              <div className="ml-2 text-sm font-semibold">Кирилл Куклачев</div>
            </button>
            <button
              className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
            >
              ...
              <div className="ml-2 text-sm font-semibold">Николай Дроздов</div>
            </button>
            <button
              className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
            >
              ...
              <div className="ml-2 text-sm font-semibold">Кристина Поздова</div>
            </button>
            <button
              className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
            >
              ...
              <div className="ml-2 text-sm font-semibold">Илья Сидоров</div>
            </button>
          </div>
        </div>
      </div>
              ...
              <div className="grid grid-cols-12 gap-y-2">
                <div className="col-start-1 col-end-8 p-3 rounded-lg">
                  <div className="flex flex-row items-center">
                    <div
                      className="flex items-center justify-center h-10 p-3 rounded-full bg-indigo-500 flex-shrink-0"
                    >
                      Мария Кюри
                    </div>
                    <div
                    ...
                    >
                      <div>Кто выставил строительный мусор в подъезде?</div>
                    </div>
                  </div>
                </div>
                <div className="col-start-1 col-end-8 p-3 rounded-lg">
                  <div className="flex flex-row items-center">
                    ...
                    >
                      <div>
                        Мне кажется это из 63 квартиры, там делают ремонт уже месяц
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-start-1 col-end-8 p-3 rounded-lg">
                  <div className="flex flex-row items-center">
                    ...
                    <div
                      className="relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl"
                    >
                      <div>Молодой человек, от Вашего ремонта одни проблемы</div>
                    </div>
                  </div>
                </div>
                <div className="col-start-6 col-end-13 p-3 rounded-lg">
                  <div className="flex items-center justify-start flex-row-reverse">
                    ...
                    >
                      <div>
                        Постараюсь минимизировать проблемы от моего ремонта))
                      </div>
                      <div
                ...
                <div className="col-start-1 col-end-8 p-3 rounded-lg">
                  <div className="flex flex-row items-center">
                    ...
                    >
                      <div>
                        Простите это был я, скоро уберу
                      </div>
                    </div>
                  </div>
                </div>
